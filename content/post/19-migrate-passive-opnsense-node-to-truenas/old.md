...
![[truenas-create-new-vlan-interface.png]]
...
![[truenas-network-confirm-add-vlans.png]]
...
![[truenas-network-mgmt-bridge.png]]

Final view before apply:

![[truenas-network-changes-before-apply.png]]
...
![[opnsense-update-dnsmasq-override-truenas-bridge.png]]

Then I attempted to flip TrueNAS from static to DHCP:

![[truenas-network-bridge-switch-static-to-dhcp.png]]
...
![[truenas-vm-opnsense-start-shell.png]]
